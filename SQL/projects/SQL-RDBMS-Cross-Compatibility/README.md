...
* **Schema Setup:** ![MySQL Setup](./screenshots/mysql-full-setup.png)
...
* **Schema Setup:** ![Postgres Setup](./screenshots/postgres-full-setup.png)
* **Query Results:** ![Postgres Results](./screenshots/postgres-query-results.png)

### 3. SQL Server (T-SQL) Implementation
Utilizing `IDENTITY` columns and `NVARCHAR` for professional-grade Unicode support.
* **Schema Setup:** ![SQL Server Setup](./screenshots/sqlserver-full-setup.png)
